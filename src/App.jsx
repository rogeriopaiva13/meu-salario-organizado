...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (mesSalvo !== mesAtual) {
      ...
      const totalGastosAntigos = gastosAntigos.reduce((acc, item) => acc + Number(item.valor || 0), 0);
...
https://meu-salario-organizado.vercel.app/`;
  ...
  function limparMes() {
    const confirmar = window.confirm("Tem certeza que deseja apagar os dados do mês?");
    if (!confirmar) return;
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ margin: 0, fontSize: "13px", opacity: 0.85 }}>Saldo disponível</p>
          <h1 style={{ margin: "6px 0", color: "#FDD835" }}>{moeda(saldo)}</h1>
      ...
      <div style={{ padding: "16px", marginTop: "-10px" }}>
            ...
            <div style={card}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px" }}>
                <div style={{ background: "#e8f1ff", padding: "14px", borderRadius: "18px" }}>
                  <small>Entrou</small>
                  <strong style={{ display: "block", color: "#0D47A1" }}>{moeda(receitas)}</strong>
                </div>

                <div style={{ background: "#fff8d6", padding: "14px", borderRadius: "18px" }}>
                  <small>Saiu</small>
                  <strong style={{ display: "block", color: "#8a6d00" }}>{moeda(saidas)}</strong>
                </div>
              </div>
        ...
        {tela === "historico" && (
          <div style={card}>
            ...
            {historico.length === 0 && <p>Nenhum mês fechado ainda.</p>}
