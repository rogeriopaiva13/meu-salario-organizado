  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <p style={{ fontSize: "15px", margin: 0 }}>Saldo disponível</p>
      ...
      {tela === "metas" && (
        <div style={{ padding: "20px" }}>
          <div style={card}>
            ...
            <p style={{ fontSize: "18px" }}>Sua meta atual é:</p>

            <h1 style={{ color: "#0D47A1", fontSize: "42px" }}>
              {moeda(meta)}
            </h1>
          </div>
        </div>
      ...
      >
        <button
          ...
          style={{
            ...
            border: "none",
            color: tela === "inicio" ? "#0D47A1" : "#7b8794",
            fontWeight: "bold",
            fontSize: "14px",
          }}
        >
        ...
        <button
          ...
          style={{
            background: "transparent",
            border: "none",
            color: tela === "gastos" ? "#0D47A1" : "#7b8794",
            fontWeight: "bold",
            fontSize: "14px",
          }}
        >
        ...
        <button
          ...
          style={{
            background: "transparent",
            border: "none",
            color: tela === "metas" ? "#0D47A1" : "#7b8794",
            fontWeight: "bold",
            fontSize: "14px",
          }}
        >
        ...
        <button
          ...
          style={{
            background: "transparent",
            border: "none",
            color: tela === "perfil" ? "#0D47A1" : "#7b8794",
            fontWeight: "bold",
            fontSize: "14px",
          }}
        >
